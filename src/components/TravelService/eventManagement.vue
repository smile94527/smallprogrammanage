    ...
    color: rgb(245, 125, 1);">
        ...
        <div class="contentPage">
            <el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
                ...
                <el-table-column prop="competitionFullName" label="出行服务全称"></el-table-column>
                <el-table-column prop="competitionName" label="出行服务简称"></el-table-column>
                <el-table-column prop="competitionAddress" label="出行服务地址" width="150px"></el-table-column>
                <el-table-column prop="competitionBeginTimeStr" label="出行开始时间"></el-table-column>
                <el-table-column prop="competitionEndTimeStr" label="出行结束时间"></el-table-column>
                ...
                <el-table-column label=" 操作" width="220">
                    <template slot-scope="scope">
                        ...
                        <el-button size="mini" type="primary" icon="el-icon-edit" style="width: 41%;"
                            @click="gameIntroduce(scope.$index, scope.row)">服务介绍
                        </el-button>
                        <el-button size="mini" type="primary" icon="el-icon-edit"
                            style="width: 41%;    margin-left: 2px;" @click="enlistAsk(scope.$index, scope.row)">报名要求
                        </el-button>
                        <el-button size="mini" type="primary" icon="el-icon-edit" style="width: 41%;"
                            @click="Locationofride(scope.$index, scope.row)">乘车地点
                        </el-button>
        ...
        <el-dialog :title="title" :visible.sync="dialogFormVisibleqx" :close-on-click-modal="false" id="addNewlogqxxg">
            <el-form ref="formData" :model="formData" :rules="rules" label-width="122px" style="color:black">
                <el-form-item label="出行服务全称" prop="competitionFullName">
                    <el-input v-model="formData.competitionFullName"></el-input>
                </el-form-item>
                <el-form-item label="出行服务简称" prop="competitionName">
                    <el-input v-model="formData.competitionName"></el-input>
                </el-form-item>

                <el-form-item label="出行开始时间" prop="competitionBeginTimeStr">
                ...
                <el-form-item label="出行结束时间" prop="competitionEndTimeStr">
                ...
                <el-form-item label="出行服务发布" prop="enable">
                    <el-select v-model="formData.enable" placeholder="请选择出行服务是否发布">
                ...
                <el-form-item label="出行服务地址" prop="competitionAddress" style="width:100%">
        ...
        methods: {
            ...
            gameIntroduce(index, row) {
                let routes = this.$router.resolve({
                    ...
                    component: resolve => require(['../TravelService/Picture_management.vue'], resolve),
                    meta: {
                        title: '出行服务介绍'
                    },
                });
            ...
            Locationofride(index, row) {
                let routes = this.$router.resolve({
                    ...
                    component: resolve => require(['../SystemManage/dictionary.vue'], resolve),
                    meta: {
                        title: '出行服务介绍'
                    },
                });
            ...
            getAlldata(pageNo, pageSize) {
                ...
                getAlleventManagementData(pageNo, pageSize, "travelService").then((
                    data) => {
                    if (data.code == "403") {
                        Cookies.remove('TokenKey')
                        this.$router.push({
