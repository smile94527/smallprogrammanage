    ...
    color: rgb(245, 125, 1);">
            ...
            <el-row style="margin-bottom:7px" :gutter="0">
                <el-col :span="6" id="feedbackType" class="feedbackType">
                    <label>赛事名称：</label>
                    <el-select v-model="divisionId" style="width: 72%;" @change="getcontestantGroup()">
                ...
                <el-col :span="5" class="feedbackType">
                    <label>参赛组别：</label>
                    <el-select placeholder="请选择参赛组别" v-model="groupID" style="width: 72%;" @change="onSelectedDrug()">
                ...
                <el-col :span="5" class="feedbackType">
                    ...
                    <label>参赛项目：</label>
                    <el-select placeholder="请选择参赛项目" v-model="projectiD" style="width: 72%;">
                        <el-option value="">请选择</el-option>
                ...
                <el-col :span="6" class="feedbackType">
                  ...
                  <el-col :span="1" style="position: relative;float: right; margin-top: 8px; margin-right: 45px;">
                    <el-button type="primary" size="mini" style="width: 45px;" @click="export2Excel"> <i class="el-icon-printer"></i>导出
                    </el-button>
                </el-col>
            ...
            <el-row style="    padding-bottom: 10px;" :gutter="0">
                <el-col :span="6" class="feedbackType">
                    ...
                    <label>参&nbsp;赛&nbsp;人&nbsp;：</label>
                    <el-input v-model="userName" placeholder="请输入团队名称" style="width: 72%;"></el-input>

                </el-col>
                <el-col :span="5" class="feedbackType">
                    <label>是否支付：</label>
                    <el-select placeholder="请选择是否支付" v-model="applyId" style="width: 72%;"
                         disabled="disabled">
                        <el-option value=" ">请选择</el-option>
                ...
                <el-col :span="5" class="feedbackType">
                    <label>团队名称：</label>
                    <el-input v-model="teamName" placeholder="请输入团队名称" style="width: 72%;"></el-input>
        ...
        <div class="contentPage">
            <el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
                ...
                <el-table-column prop="contestantName" label="参赛人" ></el-table-column>
                ...
                <el-table-column prop="contestantCertificateCode" label="参赛人证件号码" width="220px"></el-table-column>
                <el-table-column prop="contestantPhone" label="参赛人电话" width="220px"></el-table-column>
                ...
                <el-table-column prop="contestantGroup" label="参赛组别"></el-table-column>
                <el-table-column prop="contestantDivisionName" label="参赛项目" ></el-table-column>
                ...
                <el-table-column prop="teamLeaderName" label="团队领队"></el-table-column>
                   <el-table-column prop="teamLeaderPhone" label="领队电话" width="220px"></el-table-column>
...
<script>
    ...
    import {
        getEnrolment_enquiry_data,
        getMatchData,
        getcontestantGroup,
        getcontestantDivisionName,
        getEnrolment_enquiryDcdata
    ...
    export default {
        ...
        methods: {
            ...
            getAlldata(pageNo, pageSize) {
                ...
                getEnrolment_enquiry_data(csdata).then((
                    data) => {
                    if (data.code == "403") {
                        // this.$message({
                        //     type: 'error',
            ...
            handleCurrentChange(val) {
              ...
              export2Excel() {
                ...
                getEnrolment_enquiryDcdata(csdata).then((data) => {
                    if (data.result.length > 0) {  
                        ...
                        require.ensure([], () => {
                            ...
                            const tHeader = ['参赛人', '性别', '年龄','国家', '参赛人证件号码', '参赛人电话','参赛组别', '参赛项目',
                                '报名费用',
                                '团队名称',
                                '团队领队',
                                '领队电话'
                            ...
                            // 上面设置Excel的表格第一行的标题
                            const filterVal = ['contestantName', 'contestantSex', 'contestantBirthday','contestantNationality',
