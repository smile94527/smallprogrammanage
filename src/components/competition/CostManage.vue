    ...
    color: rgb(245, 125, 1);">
            ...
            <el-row style="padding-bottom: 7px;" :gutter="0">
                ...
                <el-col :span="4" class="feedbackType">
                    <label>参赛组别：</label>
                    <el-select placeholder="请选择参赛组别" v-model="groupID" style="width:62%">
                ...
                <el-col :span="5" class="feedbackType">
                    <label>参赛人姓名：</label>
                    <el-input v-model="contestantName" placeholder="请输入参赛人姓名" style="width:62%"></el-input>
        ...
        <div class="contentPage">
            <el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
                ...
                <el-table-column prop="competitionName" label="赛事名称" width="240px"></el-table-column>
                <el-table-column prop="userName" label="参赛人姓名" width="100px"></el-table-column>
                ...
                <el-table-column prop="groupName" label="参赛组别" width=""></el-table-column>
                <el-table-column prop="divisionName" label="参赛项目" width="150px"></el-table-column>
    ...
    background-color: #7d7b7b;">退款
        ...
        <el-dialog :title="title" :visible.sync="dialogFormVisibleqx" :close-on-click-modal="false" id="addNewlogqxxg">
            <el-form ref="formData" :model="formData" :rules="rules" label-width="100px" class="demo-ruleForm"
                ...
                <el-form-item label="参赛人姓名" prop="userName">
