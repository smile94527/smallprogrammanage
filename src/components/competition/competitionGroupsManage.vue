    ...
    color: rgb(245, 125, 1);">
            ...
            <el-row style="padding-bottom:7px" :gutter="0">
                ...
                <el-col :span="6" id="feedbackType" class="feedbackType">
                    <label>赛事名称：</label>
                    <el-select v-model="divisionId" style="width: 74%;" @change="getcontestantGroup()">
                ...
                <el-col :span="5" class="feedbackType">
                    ...
                    <label>性别：</label>
                    <el-select placeholder="请选择性别" v-model="sex" style="width: 72%;">
                        <el-option value="">请选择</el-option>
        ...
        <div class="contentPage">
            <el-table v-loading="loading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading"
                ...
                <el-table-column prop="group" label="组别" width=""></el-table-column>
                ...
                <el-table-column prop="maxAge" label="参与的最大年龄"></el-table-column>
                <el-table-column prop="minAge" label=" 参与的最小年龄"></el-table-column>
                <el-table-column prop="projectName" label="项目名称"></el-table-column>
                <el-table-column prop="peoNumber" label=" 团队参与最少人数"></el-table-column>
                 <el-table-column prop="maxPeoNumber" label=" 团队参与最多人数"></el-table-column>
                  <el-table-column prop="" label="特殊验证">
                           <template slot-scope="scope">
                        <span v-if="scope.row.specialValidation=='0'"> 无验证</span>
                        <span v-if="scope.row.specialValidation=='1'">男女混合校验</span>
                    </template>
                  </el-table-column>
        ...
        <el-dialog :title="title" :visible.sync="dialogFormVisiblezb" :close-on-click-modal="false" id="addNewlogqxxg">
            <el-form ref="formData" :model="formData" :rules="rules" label-width="117px" style="color:black">
                ...
                <el-form-item label="参与最少人数" prop="peoNumber">
                    <el-input v-model.number="formData.peoNumber"></el-input>
                </el-form-item>
                 <el-form-item label="参与最多人数" prop="maxPeoNumber">
                    <el-input v-model.number="formData.maxPeoNumber"></el-input>
                </el-form-item>
                 <el-form-item label="特殊验证" prop="specialValidation ">
                    <!-- <el-input v-model.number="formData.specialValidation"></el-input> 0 ：    1：男女混合校验-->
                       <el-select v-model="formData.specialValidation " placeholder="请选择">
                        <el-option label="请选择" value=""></el-option>
                        <el-option label="无验证" value="0"></el-option>
                        <el-option label="男女混合校验" value="1"></el-option>
                    </el-select>
                </el-form-item>
            </el-form>
        ...
        data() {
            ...
            return {
                ...
                formData: {
                    ...
                    peoNumber: '',
                    sortNo: '',
                    maxPeoNumber:'',//  团队参与最大人数
                    specialValidation :'',// 特殊验证
                    userId: '',
        ...
        methods: {
            ...
            handleEdit(index, row) {
                ...
                this.formData = {
                    ...
                    peoNumber: row.peoNumber,
                    maxPeoNumber:row.maxPeoNumber,//  团队参与最大人数
                    specialValidation :row.specialValidation,// 特殊验证
                    sortNo: row.sortNo,
                    userId: this.$store.state.user.userId,
                };
